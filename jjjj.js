...
let cityValuee=document.getElementsByClassName("userArea")[0].addEventListener("click", function(){

    //getting the user input using the eventlistener
    let cityInputt =document.getElementsByClassName("inputBox")[0].value;
    // passing the value as a parameter to class constructor
    console.log(cityInputt)
